...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", ...props }, ref) => {
    const variants = {
      default: "bg-wit-primary text-white hover:bg-wit-primary-hover shadow-wit",
      secondary: "bg-wit-secondary text-white hover:opacity-90",
      outline: "border-2 border-wit-border bg-transparent text-wit-text hover:bg-wit-surface",
