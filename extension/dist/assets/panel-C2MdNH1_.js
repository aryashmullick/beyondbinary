...
const TooltipContent = reactExports.forwardRef(({ className, sideOffset = 4, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Content2,
  {
    ...
    sideOffset,
    className: cn(
      "z-[999999] overflow-hidden rounded-wit bg-wit-text px-3 py-1.5 text-wit-sm text-white font-display animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95",
      className
    ),
    ...props
  }
...
const Switch = reactExports.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  ...
  {
    className: cn(
      "peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wit-primary focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-wit-primary data-[state=unchecked]:bg-wit-border",
      className
    ),
    ...props,
    ref,
...
const Pill = ({ active, onClick, children, color: color2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "button",
  {
    onClick,
...
const Label = ({ children }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "p",
  {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          background: enabled ? "linear-gradient(135deg, rgba(74,111,165,0.08), rgba(107,158,107,0.06))" : "#F5F0E8",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: enabled && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: showLegend && legend.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { height: 0, opacity: 0 },
              animate: { height: "auto", opacity: 1 },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: {
                background: directorEnabled ? "rgba(107,158,107,0.06)" : "#F5F0E8",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-2.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-[14px] text-stone-800", children: "Director" }),
                    isTracking && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      motion.div,
                      {
                        animate: { scale: [1, 1.3, 1] },
                        transition: { duration: 1.5, repeat: Infinity },
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "w-3.5 h-3.5 text-green-600" })
                      }
                    )
                  ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-[11px] text-stone-400", children: backendConnected ? "Connected" : "Offline" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
          colorCodingActive && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          directorModeActive && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: "px-2 py-[2px] rounded-full text-[10px] font-display font-semibold text-white",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.button,
    {
      ...
      style: {
        ...
        boxShadow: isActive ? "0 4px 16px rgba(0,0,0,0.1), 0 0 0 1px #E2D9CA" : "0 2px 8px rgba(0,0,0,0.08), 0 0 0 1px #E8E0D4"
      },
...
async function getLegend(scheme = "default") {
...
const App = () => {
  ...
  const [colorCodingEnabled, setColorCodingEnabled] = reactExports.useState(false);
  const [colorScheme, setColorScheme] = reactExports.useState("default");
  const [emphasis, setEmphasis] = reactExports.useState("normal");
  const [showFunctionWords, setShowFunctionWords] = reactExports.useState(true);
  const [isProcessing, setIsProcessing] = reactExports.useState(false);
  const [directorModeEnabled, setDirectorModeEnabled] = reactExports.useState(false);
  const [isTracking, setIsTracking] = reactExports.useState(false);
  const [crowdingIntensity, setCrowdingIntensity] = reactExports.useState("medium");
  reactExports.useEffect(() => {
    const check = async () => {
    ...
    check();
    const interval = setInterval(check, 1e4);
  ...
  reactExports.useEffect(() => {
    const handler = (event) => {
      var _a;
      if (((_a = event.data) == null ? void 0 : _a.source) !== "wit-content") return;
  ...
  const handleColorToggle = reactExports.useCallback(
    (enabled) => {
  ...
  const handleEmphasisChange = reactExports.useCallback(
    (emp) => {
      setEmphasis(emp);
      if (colorCodingEnabled) {
        sendToContent({
  ...
  const handleShowFunctionWordsChange = reactExports.useCallback(
    (show) => {
  ...
  const handleDirectorToggle = reactExports.useCallback(
    (enabled) => {
  ...
  const handleCrowdingChange = reactExports.useCallback(
    (intensity) => {
